  ...
  return (
    <>
      ...
      <div className="container w-full h-[650px] bg-gray-200 mx-auto rounded-2xl flex p-5 items-start justify-center">
        <div className="flex rounded-2xl mr-6 w-[45%] h-full justify-center p-2 bg-white">
            <img
              src={data?.image}
              alt=""
        ...
        <div className="bg-gray-200 w-[55%] p-4 rounded-md">
          <h2 className="text-5xl font-semibold mb-4 text-gray-800">{data?.title}</h2>
          <p className="my-2 text-lg text-gray-700">{data?.description}</p>
          <p className="text-gray-800 font-semibold text-2xl">
            Category: <span className="font-medium text-gray-700">{data?.category}</span>
          </p>
          <div className="flex items-center gap-10 my-2">
            <p className="text-2xl text-gray-800 font-semibold">
              Rate: <span className="font-medium text-gray-700">{data?.rating?.rate}</span>
            </p>
            <p className="text-2xl text-gray-800 font-semibold">
              Count: <span className="font-medium text-gray-700">{data?.rating?.count}</span>
            </p>
          </div>            
